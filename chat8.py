...
class Chatbox(customtkinter.CTk):
    def __init__(self):
        ...
        self.middle_button_5 = create_button(self, self.middle_bottom, 1, 0, text='Snake 1', command=self.snake)
        self.middle_button_6 = create_button(self, self.middle_bottom, 2, 0, text='Snake 2', command=self.snake2)
